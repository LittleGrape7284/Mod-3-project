...
function showCal(){ //defined function called showTemp
    var size= document.getElementById("selectedCal").value; // Declares a variable 'size' and assigns it the value of an HTML element with id "size".
    document.getElementById("sliderVal").innerHTML= size +" Calories or less" // Updates the inner HTML of an element with id "feedback" to display the 'size' value followed by " °F".
}
